...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "UPDATE Customers\r\nSET       CompanyName = @CompanyName, ContactName = @ContactNam" +
                "e, ContactTitle = @ContactTitle, Address = @Address\r\nWHERE (CustomerID = @Origin" +
                "al_CustomerID); ";
            ...
            this._commandCollection[2].CommandText = "DELETE FROM [Customers] WHERE ([CustomerID] = @CustomerID)";
            ...
            this._commandCollection[4].CommandText = "INSERT INTO Customers\r\n             (CustomerID, CompanyName, ContactName, Contac" +
                "tTitle, Address)\r\nVALUES (@CustomerID,@CompanyName,@ContactName,@ContactTitle,@A" +
                "ddress);   \r\n";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CompanyName", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "CompanyName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ContactName", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "ContactName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ContactTitle", global::System.Data.SqlDbType.NVarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "ContactTitle", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int ActualizarCliente(string CompanyName, string ContactName, string ContactTitle, string Address, string Original_CustomerID) {
            ...
            if ((Original_CustomerID == null)) {
                ...
                command.Parameters[4].Value = ((string)(Original_CustomerID));
            }
        ...
        public virtual int InsertarCliente(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address) {
